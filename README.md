...
3. Последний тип комментария — это __/** */__. Он начинается с /** и заканчивается */. Это может быть однострочный или многострочный комментарий. Любые символы, расположенные между /** и */, будут закомментированы независимо от того, сколько строк они занимают.
